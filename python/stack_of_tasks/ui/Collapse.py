...
class CollapseWithDelete(Collapse):
    ...
    def __init__(self, parent=None, title="Title", deleteable=True) -> None:
    ...
    def setDeletabel(self, deleteable):
        self.deleteButton.setVisible(deleteable)
        self.deleteButton.setEnabled(deleteable)
